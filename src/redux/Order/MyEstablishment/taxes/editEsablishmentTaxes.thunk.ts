...
export const EditEstablishmentTexPercentage = createAsyncThunk<
  IResponseEditMyEstablishment,
  {tax: number; estId: string}
>('Establishment/taxes/edit}', async (state, {rejectWithValue}) => {
  try {
    ...
    const res = await instance
      .put(
        `/order/establishment/editVat/${state.estId}`,
